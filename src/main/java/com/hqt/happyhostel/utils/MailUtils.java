...
public class MailUtils {
    ...
    public boolean sendMail(String toEmail, String subject, String body) {
        ...
        try {
            final String fromEmail = "nsthanh.k21tt@kontum.udn.vn";
            // Mat khai email cua ban
            final String password = "indc lowd rquc wezd";
            ...
            msg.setFrom(new InternetAddress(fromEmail, "NoReply-ST"));
    ...
    public boolean sendBCCEmail(ArrayList<String> bcc, String subject, String body) {
        ...
        try {
            ...
            message.setFrom(new InternetAddress(fromEmail, "NoReply-ST"));
